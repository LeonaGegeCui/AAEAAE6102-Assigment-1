...
% Opensky settings: 
% settings.fileName           = 'E:\gegecui_phd_lectures\2024-2025-1-spring\2025-Satellite\Assignment-1\data\Opensky.bin';
% Urban settings: 
settings.fileName           = 'E:\gegecui_phd_lectures\2024-2025-1-spring\2025-Satellite\Assignment-1\data\Urban.dat';
...
% Opensky: Intermediate, sampling and code frequencies
% settings.IF                 = -1580e6+1575.42e6;     % [Hz]
% settings.samplingFreq       = 58e6;        % [Hz]
% settings.codeFreqBasis      = 1.023e6;     % [Hz]
% Urban: Intermediate, sampling and code frequencies
settings.IF                 = 0;     % [Hz]
...
settings.acqThreshold       = 5; % original 3.5
...
settings.navSolPeriod       = 500;          %[ms] 500 @@@@ 1
