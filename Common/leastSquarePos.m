function [pos,el, az, dop, v] = leastSquarePosweighted(satpos,obs,settings,satvelocity,doppler)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
weight = ones(nmbOfSatellites, 1); % add initialization for weights
...
for iter = 1:nmbOfIterations
    ...
    for i = 1:nmbOfSatellites
        if iter == 1
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            weight(i)=sin(el(i))^2; %% update weights
